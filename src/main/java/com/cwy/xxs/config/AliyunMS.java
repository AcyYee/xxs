...
public class AliyunMS {
    ...
    static final String accessKeyId = "LTAImyh5tqpmgXuo";
    static final String accessKeySecret = "Kxfqvef4PKzAlY9lqSfjIYB5FilQEg";
    ...
    public static SendSmsResponse sendSms(String phoneNumber, String smsCode) throws ClientException {
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_116750372");
